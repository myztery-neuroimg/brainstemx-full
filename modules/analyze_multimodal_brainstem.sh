...
cluster --in="$OUTDIR/FLAIR_brainstem.nii.gz" --thresh=202  --connectivity=6 \
...
fslmaths "$OUTDIR/T2_SWI_AX_8_to_FLAIR_brainstem.nii.gz" -uthr 93 -bin "$OUTDIR/swi_hypo_mask.nii.gz" 
